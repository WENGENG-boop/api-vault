import type { AddKeyInput, ApiKeyInput, AppState, BalanceTestResult, CloudflaredApiResponse, CloudflaredConfig, CloudflaredStatus, LocalService, ProviderInput } from "../../../shared/types";
